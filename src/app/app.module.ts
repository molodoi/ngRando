...
@NgModule({ //NgModule decorator and metadata.
  imports:      [ BrowserModule ],//Spécifie une liste de modules dont les directives / pipes exportés devraient être disponibles pour les modèles de ce module. Cela peut également contenir ModuleWithProviders
